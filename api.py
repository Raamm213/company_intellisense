...
app = FastAPI(title="Company Intel API", description="AI-powered company intelligence extraction and validation")
...
async def execute_pipeline(company: str):
    try:
        ...
        try:
            ...
            consolidated_filename = Path("consolidated") / f"{comp_slug}_consolidated.json"
